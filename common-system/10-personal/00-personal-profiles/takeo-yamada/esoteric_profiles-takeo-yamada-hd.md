...
# Gene Keys - Activation Sequence（才能と存在のコア）
スフィア	Gene Key	Siddhi（神聖）	Gift（才能）	Shadow（影）
Life’s Work	5	5	Timelessness Patience Impatience
Evolution	35	5	Boundlessness Adventure Hunger
Radiance	47	1	Transfiguration	Transmutation	Oppression
Purpose (Core)	22	1	Grace	Graciousness	Dishonour
...
# Pearl Sequence （才能の社会的発露）
スフィア	Gene Key	Siddhi	Gift	Shadow
Vocation（天職）	48	2	Wisdom	Resourcefulness	Inadequacy
Culture（文化圏）	20	1	Presence	Self assurance	Superficiality
Brand（拡張性）	5	5	Timelessness	Patience	Impatience
Pearl（真珠）	23	6	Quintessence	Simplicity	Complexity
...
⭐️Dream Rave
# Dream Rave（睡眠時チャート）
| Type（夢の中）| Reflector（反映型）
| Active Centers（作動）| Ajna, Spleen, Ego
| Dream Environment | Cold-Wet Mountains
| Dream Color | Desire（欲求）
